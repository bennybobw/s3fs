...
location ~ (^/sites/._/files/imagecache/|^/sites/default/themes/._/includes/fonts/|^/sites/.\*/files/styles/) {
expires max;
...
location ~ (^/s3/files/styles/|^/sites/._/files/imagecache/|^/sites/default/themes/._/includes/fonts/|^/sites/.\*/files/styles/) {
expires max;
try_files $uri @rewrite;
}
...
// All the s3fs config settings start with "s3fs\_"
...
$conf['s3fs_presigned_urls'] = "300|presigned-files/_\n60|other-presigned/_";
...
With Root Folder, _everything_ s3fs does is contained to the specified folder
...
_was_ reflected in the uris, and you had to configure your file and image
